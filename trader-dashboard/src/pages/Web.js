...
//   return (
//     <motion.div
//       className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 hover:border-emerald-400/30 shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer"
...
//       <a href={link} target="_blank" rel="noopener noreferrer" className="text-emerald-400 text-sm font-medium hover:underline">
//         Visit Resource
//       </a>
//     </motion.div>
//   );
...
//   return (
//     <div className="relative w-full h-64 bg-black/20 rounded-2xl p-6 border border-emerald-500/30 backdrop-blur-md">
//       <div className="absolute inset-0 flex items-center justify-center">
//         <div className="grid grid-cols-12 gap-2 w-full h-40 items-end px-4">
...
//             >
//               <motion.div
//                 className={`w-3 rounded-t ${index === activePoint
...
//                 }}
//               />
//               <span className={`text-xs mt-2 ${index === activePoint ? "text-emerald-400 font-bold" : "text-gray-400"
//                 }`}>
//                 {point.label}
//               </span>
...
//               {index === activePoint && (
//                 <motion.div
//                   className="absolute -top-8 bg-emerald-500 text-white text-xs font-bold px-2 py-1 rounded-lg"
...
//         <div className="bg-black/40 backdrop-blur-sm rounded-lg px-4 py-2 border border-emerald-500/20">
//           <span className="text-emerald-400 text-sm">Annual Growth: +42%</span>
//         </div>
//       </div>
//     </div>
//   );
...
//       >
//         <h2 className="text-3xl font-bold text-white mb-4">Market Trends & Analysis</h2>
...
//         >
//           <h3 className="text-xl font-bold text-white mb-4">Live Market Performance</h3>
...
//           className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20"
//         >
//           <h3 className="text-xl font-bold text-white mb-4">Key Market Indicators</h3>
...
//                 <span className={`font-bold ${indicator.change === "up" ? "text-green-400" : "text-red-400"}`}>
//                   {indicator.value}
//                 </span>
//               </motion.div>
//             ))}
...
//     {
//       title: "Moneycontrol",
//       description: "Popular platform for Indian stock investors, offering news, trends, charts, and discussion forums.",
...
//     {
//       title: "TradingView",
//       description: "Widely used globally for charts, screeners, technical analysis tools, and a large community for sharing ideas.",
...
//     {
//       title: "NSE India",
//       description: "Official website of the National Stock Exchange of India, providing reliable market data and financial reports.",
...
//       description: "Leading source of up-to-the-minute financial news, analysis, and expert insights for the Indian stock market.",
...
//     {
//       title: "Investing.com",
//       description: "Global platform with in-depth insights into various markets, including Indian stocks, featuring charts and technical indicators.",
...
//     {
//       title: "BSE India",
//       description: "Official website of the Bombay Stock Exchange, providing market data, financial reports, and corporate governance information.",
...
//       description: "Comprehensive modules and tutorials covering stock market basics, technical analysis, and trading strategies.",
...
//     {
//       title: "Investopedia",
//       description: "Extensive resource with definitions and examples of stock market terms and concepts for all experience levels.",
...
//       description: "Understanding your audience (beginners, experienced traders, long-term investors) helps tailor content to their needs.",
//       icon: "👥",
//       color: "bg-blue-500/20"
//     },
//     {
...
//           className="text-center mb-12"
//         >
//           <h2 className="text-3xl font-bold text-white mb-4">Your Stock Market Toolkit</h2>
//           <p className="text-gray-200 max-w-2xl mx-auto">
...
//       {/* Market Trends Section - Replaces FAQ */}
//       <MarketTrendsSection />
...
//           className="text-center mb-12"
//         >
//           <h2 className="text-3xl font-bold text-white mb-4">Content Strategy Approach</h2>
//           <p className="text-gray-200 max-w-2xl mx-auto">
...
//               viewport={{ once: true }}
//             >
//               <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 hover:border-emerald-400/30 shadow-lg hover:shadow-xl transition-all duration-300 h-full">
//                 <div className="flex items-center mb-4">
...
//               style={{ transformStyle: 'preserve-3d' }}
//             >
//               <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 hover:border-emerald-400/30 shadow-lg hover:shadow-xl transition-all duration-300">
...
//           className="text-center mb-12"
//         >
//           <h2 className="text-3xl font-bold text-white mb-4">How Your Dashboard Works</h2>
//           <p className="text-gray-200 max-w-2xl mx-auto">
...
//           style={{ transformStyle: 'preserve-3d' }}
//         >
//           <h2 className="text-3xl font-bold mb-4">{investorOnboarding.title}</h2>
...
//             </div>
//             <div>
//               <h3 className="text-lg font-semibold mb-6">Investment Tools</h3>
      ...
      <nav className="bg-black/30 backdrop-blur-md py-4 px-4 sm:px-6 flex justify-between items-center sticky top-0 z-50 border-b border-emerald-500/30">
        <div className="flex items-center space-x-6 sm:space-x-10">
          <motion.div
            ...
            style={{ transformStyle: "preserve-3d" }}
          >
            <div className="bg-gradient-to-r from-emerald-500 to-teal-600 w-8 h-8 sm:w-10 sm:h-10 rounded-xl flex items-center justify-center shadow-md">
        ...
        <div className="flex items-center space-x-4">
          <div className="relative hidden sm:block">
            <svg
              ...
              className="h-4 w-4 sm:h-5 sm:w-5 absolute left-3 top-2.5 text-emerald-400"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
            <div>
              <div className="flex items-center mb-4 sm:mb-6">
                <div className="bg-gradient-to-r from-emerald-500 to-teal-600 w-8 h-8 sm:w-10 sm:h-10 rounded-xl flex items-center justify-center">
                  <span className="text-white font-bold text-xs sm:text-sm">VC</span>
                </div>
