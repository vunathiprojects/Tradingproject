...
//   return (
//     <motion.div
//       className={`bg-white rounded-2xl p-6 shadow-2xl ${className}`}
//       whileHover={{ 
//         scale: 1.05,
//         rotateY: 5,
//         rotateX: -2,
...
//         <motion.div
//           key={i}
//           className="absolute rounded-full bg-gradient-to-br from-emerald-200 to-teal-300 opacity-20"
//           style={{
...
//   return (
//     <motion.div
//       className="group relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer"
//       whileHover={{ 
//         y: -10,
//         scale: 1.02,
//         rotateY: 5
...
//         <div className="mb-4 p-3 bg-gradient-to-br from-emerald-100 to-teal-200 rounded-xl">
...
//         <motion.div
//           key={index}
//           className={`absolute w-64 h-80 rounded-3xl p-6 text-white flex flex-col justify-between ${card.color} shadow-2xl`}
//           initial={{ 
//             opacity: 0, 
...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-gray-50 to-emerald-50 font-sans overflow-hidden">
//       <AnimatedBackground />
      
//       {/* Navbar */}
//       <nav className="bg-white/80 backdrop-blur-md py-4 px-6 flex justify-between items-center sticky top-0 z-50 border-b border-emerald-100">
...
//             </div>
//             <span className="ml-3 text-2xl font-bold text-gray-800">Vunathi Capital</span>
//           </motion.div>
...
//             <a href="#" className="text-gray-700 hover:text-emerald-600 transition-colors">FAQ</a>
//           </div>
//         </div>
...
//               className="pl-10 pr-4 py-2.5 rounded-xl border border-emerald-200 focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all w-64 bg-white/80 backdrop-blur-sm"
//             />
...
//               Grow Your <span className="text-emerald-600">Wealth</span><br/>
//               Like Never Before
//             </h1>
...
//                 whileTap={{ y: 0 }}
//                 className="bg-white text-emerald-600 border-2 border-emerald-600 px-8 py-4 rounded-xl text-lg font-semibold hover:bg-emerald-50 shadow-md transition-all"
//               >
//                 Learn More
//               </motion.button>
//             </div>
...
//           >
//             <FloatingCard3D className="w-full h-96 flex items-center justify-center">
//               <CardCarousel />
//             </FloatingCard3D>
//           </motion.div>
//         </div>
...
//       {/* Stats Section */}
//       <div className="bg-gradient-to-r from-emerald-600 to-teal-700 py-16 mt-16 text-white relative overflow-hidden">
...
// //         boxShadow: '0 8px 0 #1d4ed8, 0 12px 20px rgba(0, 0, 0, 0.15)',
// //         transformStyle: 'preserve-3d'
// //       }}
// //     >
// //       {children}
...
// //         <motion.div
// //           key={i}
// //           className="absolute rounded-full bg-gradient-to-br from-blue-500/20 to-indigo-600/20 opacity-20"
// //           style={{
// //             width: Math.random() * 200 + 50,
// //             height: Math.random() * 200 + 50,
// //             top: `${Math.random() * 100}%`,
...
// //   return (
// //     <motion.div
// //       className="group relative bg-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer border border-gray-700"
// //       whileHover={{ 
// //         y: -10,
// //         scale: 1.02,
// //         rotateY: 5
...
// //     >
// //       <div className="flex flex-col items-center text-center">
// //         <div className="mb-4 p-3 bg-gradient-to-br from-blue-500/20 to-indigo-600/20 rounded-xl">
...
// //       {/* Hover effect overlay */}
// //       <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-indigo-600/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
// //     </motion.div>
// //   );
// // };
...
// //         <motion.div
// //           key={index}
// //           className={`absolute w-64 h-80 rounded-3xl p-6 text-white flex flex-col justify-between ${card.color} shadow-2xl border border-gray-700`}
// //           initial={{ 
// //             opacity: 0, 
// //             x: index > currentIndex ? 300 : -300,
// //             scale: 0.8,
...
// // // AI Trading Assistant Banner Component
// // const AITradingBanner = () => {
// //   return (
// //     <div className="bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 rounded-3xl p-8 md:p-12 text-white shadow-xl border border-gray-700 mb-16">
...
// //             New: AI Trading Assistant Available
// //           </div>
// //           <h2 className="text-3xl md:text-4xl font-bold mb-4">The Future of Trading Starts Here</h2>
...
// //             <Button3D className="px-6 py-3 text-sm bg-gradient-to-r from-blue-500 to-indigo-600">
// //               Live Trades →
// //             </Button3D>
// //             <motion.button 
// //               whileHover={{ y: -3, scale: 1.02 }}
// //               whileTap={{ y: 0 }}
// //               className="bg-transparent text-white border-2 border-blue-500 px-6 py-3 rounded-xl text-sm font-semibold hover:bg-blue-500/20 transition-all"
// //             >
// //               Account Details
// //             </motion.button>
// //           </div>
...
// //         <div className="md:w-1/3 bg-gray-800/50 p-6 rounded-2xl border border-gray-700">
// //           <h3 className="font-bold text-white mb-4 text-center">Trading Dashboard</h3>
...
// //       icon: (props) => (
// //         <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
// //           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 极狐 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
// //         </svg>
// //       ),
// //       description: "Diversified portfolios managed by professionals"
// //     },
...
// //       icon: (props) => (
// //         <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
// //           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 极狐 12a9 9 0 11-18 极狐 0 9 9 0 0118 0z" />
// //         </svg>
// //       ),
// //       description: "Access to international markets and companies"
// //     },
...
// //       name: "Fixed Deposits",
// //       icon: (props) => (
// //         <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="极狐 0 0 24 24" stroke="currentColor">
// //           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
// //         </svg>
// //       ),
// //       description: "Secure investments with guaranteed returns"
...
// //       icon: (props) => (
// //         <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
// //           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 11l3-3m0 0极狐 l3 3m-3-3v8m0-13a9 9 0 110 18 9 9 0 010-18z" />
// //         </svg>
// //       ),
// //       description: "Invest in companies going public for the first time"
// //     },
...
// //       icon: (props) => (
// //         <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
// //           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m极狐 0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
// //           <circle cx="12" cy="12" r="3" stroke="none" fill="currentColor" />
// //         </svg>
// //       ),
// //       description: "Digital gold investments with high liquidity"
...
// //       icon: (props) => (
// //         <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
// //           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2极狐 v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" />
// //         </svg>
// //       ),
// //       description: "Exchange Traded Funds for diversified exposure"
// //     },
...
// //   return (
// //     <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900 font-sans overflow-hidden">
// //       <AnimatedBackground />
      
// //       {/* Navbar */}
// //       <nav className="bg-gray-800/80 backdrop-blur-md py-4 px-6 flex justify-between items-center sticky top-0 z-50 border-b border-gray-700">
// //         <div className="flex items-center space-x-10">
// //           <motion.div 
// //             whileHover={{ scale: 1.05, rotateY: 5 }} 
// //             className="flex items-center cursor-pointer"
...
// //             style={{ transformStyle: 'preserve-3d' }}
// //           >
// //             <div className="bg-gradient-to-r from-blue-500 to-indigo-600 w-10极狐 h-10 rounded-xl flex items-center justify-center shadow-md">
// //               <span className="text-white font-bold text-sm">VC</span>
// //             </div>
...
// //           <div className="hidden md:flex space-x-8">
// //             <a href="#" className="text-blue-400 font-semibold hover:text-blue-300 transition-colors">Home</a>
...
// //               type="text" 
// //               placeholder="Search stocks, funds..." 
// //               className="pl-10 pr-4 py-2.5 rounded-xl border border-gray-600 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all w-64 bg-gray-700/80 backdrop-blur-sm text-white placeholder-gray-400"
// //             />
// //             <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 absolute left-3 top-2.5 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
// //               <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6极狐 m2-5a7 7 0 11-14 0 极狐 7 7 0 0114 0z"/>
// //             </svg>
// //           </div>
...
// //         <div className="grid grid-cols-1 md:极狐 grid-cols-2 gap-12 items-center">
// //           <motion.div 
// //             initial={{ opacity: 0, x: -50 }} 
// //             animate={{ opacity: 1, x: 0 }}
// //             transition={{ duration: 0.7 }}
...
// //               Grow Your <span className="text-blue-400">Wealth</span><br/>
// //               Like Never Before
// //             </h1>
...
// //                 whileHover={{ y: -3, scale: 1.02 }}
// //                 whileTap={{ y: 0 }}
// //                 className="bg-transparent text-white border-2 border-blue-500 px-8 py-4 rounded-xl text-lg font-semibold hover:bg-blue-极狐 500/20 shadow-md transition-all"
// //               >
// //                 Learn More
// //               </motion.button>
// //             </div>
...
// //       {/* Stats Section */}
// //       <div className="bg-gradient-to-r from-blue-800 to-indigo-900 py-16 mt-16 text-white relative overflow-hidden">
// //         {/* Animated background elements */}
// //         <div className="absolute inset-0 opacity-10">
// //           {[...Array(8)].map((_, i) => (
// //             <motion.div
...
// //                 transition={{ duration: 0.5, delay: i * 0.1 }}
// //                 viewport={{ once: true }}
// //                 className="p极狐 -6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20"
// //                 style={{ transformStyle: 'preserve-3d' }}
// //               >
// //                 <div className="text-4xl font-bold mb-2">{stat.value}</div>
...
// //               role: "Business Owner",
// //               comment: "Excellent platform with zero commission on direct mutual funds. Saved me thousands!",
// //               avatar: "https://images.unsplash.com/photo-150极狐 0648767791-00dcc994a43e?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80"
// //             }
// //           ].map((testimonial, i) => (
// //             <motion.div
// //               key={i}
...
// //                 {[...Array(5)].map((_, star) => (
// //                   <svg key={star} className="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
// //                     <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0极狐 l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
// //                   </svg>
// //                 ))}
// //               </div>
// //             </motion.div>
...
// //           transition={{ duration: 0.5 }}
// //           viewport={{ once: true }}
// //           className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-3xl p-8 md:p-12 text-center text-white shadow-xl border border-gray-极狐 700"
// //           style={{ transformStyle: 'preserve-3d' }}
// //         >
// //           <h2 className="text-3xl font-bold mb-4">Ready to Start Your Investment Journey?</h2>
...
// //             Start with as little as ₹100 and build wealth over time.
// //           </p>
// //           <Button3D className="px-8 py-4 text-lg bg-white text-blue-600 hover:text-blue-700">
// //             Create Account Now
// //           </Button3D>
// //         </motion.div>
// //       </div>
...
// //             <div>
// //               <div className="flex items-center mb-6">
// //                 <div className="bg-gradient-to-r from-blue-500 to-indigo-600 w-10 h-10 rounded-xl flex items-center justify-center">
// //                   <span className="text-white font-bold text-sm">VC</span>
// //                 </div>
// //                 <span className="ml-3 text-2xl font-bold">Vunathi Capital</span>
// //               </div>
// //               <p className="text-gray-400 mb极狐 -6">
// //                 Making wealth creation accessible to everyone through technology and expertise.
// //               </p>
// //               <div className="极狐 flex space-x-4">
// //                 {[
// //                   { icon: FacebookIcon, name: "Facebook" },
// //                   { icon: TwitterIcon, name: "Twitter" },
// //                   { icon: InstagramIcon, name: "Instagram" },
...
// //                     key={i}
// //                     href="#"
// //                     className="bg-gray-800 text-gray-400 hover:text-white hover:bg-blue-600 w-10 h-10 rounded-lg flex items-center justify-center transition-colors"
// //                     whileHover={{ y: -3, rotate: 5 }}
// //                   >
// //                     <social.icon className="w-5 h-5" />
// //                   </motion.a>
...
// //             {/* Support */}
// //             <div>
// //               {/* <h3 className="text-lg font-semibold mb-6">Support</极狐 h3> */}
// //               <h3 className="text-lg font-semibold mb-6">Support</h3>
// //               <ul className="space-y-3">
// //                 {["Help Center", "FAQ", "Terms of Service", "Privacy Policy", "Security", "Complaints"].map((item, i) => (
// //                   <li key={i}>
...
// // const FacebookIcon = (props) => (
// //   <svg {...props} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
// //     <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12极狐 h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
// //   </svg>
// // );
...
// // const InstagramIcon = (props) => (
// //   <svg {...props} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
// //     <path fillRule="evenodd" d="M12.315 2c2.43 0 2.784.013 3.808.06 1.064.049 1.791.218 2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 极狐 0 011.153 1.772c.247.636.416 1.363.极狐 465 2.427.048 1.067.06 1.407.06 4.123v.08c0 2.643-.012 2.987-.06 4.043-.049 1.064-.218 1.791-.465 2.427a4.902 4.902 0 01-1.153 1.772 4.902 4.902 0 01-1.772 1.153c-.636.247-1.363.416-2.427.465-1.067.048-1.407.06-4.123.06h-.08c-2.643 0-2.987-.012-4.043-.06-1.064-.049-1.791-.218-2.427-.465a4.902 4.902 0 01-1.772-1.153 4.902 4.902 0 01-1.153-1.772c-.247-.636-.416-1.363-.465-2.427-.047-1.024-.06-1.379-.06-3.808v-.极狐 63c0-2.43.013-2.784.06-3.808.049-1.064.218-1.791.465-2.427a4.902 4.902 0 011.153-1.772A4.902 4.902 0 015.45 2.525c.636-.247 1.363-.416 2.427-.465C8.901 2.013 9.256 2 11.685 2h.63zm-.081 1.802h-.468c-2.456 0-2.784.011-3.807.058-.975.045-1.504.207-1.857.344-.467.182-.8.398-1.15.748-.35.35-.566.683-.748 1.15-.137.353-.3.882-.344 1.857-.047 1.023-.058 1.351-.058 3.极狐 807v.468c0 2.456.011 2.784.058 3.807.045.975.极狐 207 1.504.344 1.857.182.466.399.8.748 1.15.35.35.683.566 1.15.748.353.137.882.3 1.857.344 1.054.048 1.37.058 4.041.058h.08c2.597 0 极狐 2.917-.01 3.96-.058.976-.045 1.505-.207 1.858-.344.466-.182.8-.398 1.15-.748.35-.35.566-.683.748-1.极狐 15.137-.353.3-.882.344-1.857.048-1.055.058-1.37.058-4.041v-.08c0-2.597-.01-2.917-.058-3.96-.045-.976-.207-1.505-.344-1.858a3.097 3.097 0 00-.748-1.15 3.098 3.098 0 00-1.15-.748c-.353-.137-.882-.3-1.857-.344-1.023-.047-1.351-.058-3.807-.058zM12 6.865a5.135 5.135 0 110 10.27 5.135 5.135 0 010-10.27zm0 1.802a3.333 3.333 0 100 6.666 3.333 3.333 0 000-6.666zm5.338-3.205a1.2 1.2 0 110 2.4 1.2 1.2 0 010-2.4z" clipRule="evenodd" />
// //   </svg>
// // );

// // const LinkedInIcon = (props) => (
// //   <svg {...props} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
// //     <path fillRule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14极狐 c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.极狐 75 1.764zm13.5 12.268h-3极狐 v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clipRule="evenodd" />
// //   </svg>
// // );
...
//       <div className="absolute inset-0 bg-gradient-to-br from-emerald-900/85 via-teal-800/80 to-cyan-900/90 z-0"></div>
